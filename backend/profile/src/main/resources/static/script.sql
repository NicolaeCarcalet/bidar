create table skills(skill_id bigint primary key, skill varchar(255), user_id bigint);
create table interests(interest_id bigint primary key, interest varchar(255), user_id bigint);
