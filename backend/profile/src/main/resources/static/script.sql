...
--- mysql
--- create table skills(skill_id int primary key auto_increment primary key, skill varchar(255), user_id bigint);
--- create table interests(interest_id int primary key auto_increment primary key, interest varchar(255), user_id bigint);
--- create table profile(user_id int primary key primary key, first_name varchar(255), last_name varchar(255), country varchar(255), age int);
