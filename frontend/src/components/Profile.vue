                      ...
                      <tr class="table-light">
                        ...
                        <td>
                          <button
                            ...
                            @click="deleteSkill(index, skill.skillId)"
                          >
                            Delete
                          </button>
                        </td>
                      ...
                      <tr class="table-light">
                        ...
                        <td>
                          <button
                            type="button"
                            class="btn btn-sm btn-danger"
                            @click="deleteInterest(index, interest.interestId)"
                          >
                            Delete
                          </button>
                        </td>
...
export default {
  ...
  methods: {
    getUser() {
      this.$http
        .post(this.$hostname + "/userId", { username: localStorage.getItem("username") })
        .then((response) => {
          ...
          this.$http
            .get(this.$profile + "/profile/skill/" + userId)
            .then((response) => {
          ...
          this.$http
            .get(this.$profile + "/profile/interest/" + userId)
            .then((response) => {
              let data = response.data;
    ...
    submit() {
      ...
      this.$http.post(this.$profile + "/profile", payload).then((response) => {
    ...
    submitSkills() {
      if (this.custom_skill) {
        let userId = localStorage.getItem("userId");
        this.$http
          .post(this.$profile + "/profile/skill/" + userId, {
    ...
    deleteSkill(arrayIndex, skillId) {
      ...
      let userId = localStorage.getItem("userId");
      this.$http
        .delete(this.$profile + "/profile/skill/" + userId + "/" + skillId)
        .then((response) => {
    ...
    submitInterests() {
      if (this.custom_interest) {
        let userId = localStorage.getItem("userId");
        this.$http
          .post(this.$profile + "/profile/interest/" + userId, {
    ...
    deleteInterest(arrayIndex, interestId) {
      ...
      this.$http
        .delete(
          this.$profile + "/profile/interest/" + userId + "/" + interestId
        )
        .then((response) => {
          console.log(response.data);
