          ...
          <div class="col-md-4 text-left">
            <form>
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="first_name" id="last_name" placeholder="Last name">
...
export default {
  ...
  methods: {
    getUser() {
      ...
      this.$http.post(this.$hostname + '/get-user', {username: username}).then((response) => {
